...
export class PatientHistoryComponent implements OnInit {
  ...
  // ];
  // public drugDataArr = [
  //   { name: 'Amphetamines', value: 'amphetamines' },
  //   { name: 'Heroine', value: 'heroine' },
  //   { name: 'Barbiturates', value: 'barbiturates' },
  //   { name: 'Marijuana', value: 'marijuana' },
  //   { name: 'Non Drugs', value: 'non-drugs' }
  // ];
  ...
  //       console.log('this.historyForm.controls', this.historyForm.controls.surgeryArr)
  //       this.patientData.surgery.map((r) => {
  //         console.log(r)
  //         this.surgeryDataArr.map((e, i) => {
  //           console.log('this.historyForm.controls.surgeryArr', this.historyForm.controls.surgeryArr, this.historyForm.controls.surgeryArr.value, i)
  //           this.historyForm.controls.surgeryArr.setValue([])
  //           if (e.value == r) {
  //             this.historyForm.controls.surgeryArr.value.splice(i, 0, true);
  //           } else {
  //             this.historyForm.controls.surgeryArr.value.splice(i, 0, false);
  //           }
  //         })
  //       })
  //       console.log('this.historyForm.controls.surgeryArr', this.historyForm.controls.surgeryArr)
  ...
  //     });
  //   }
  //   console.log('this.historyForm', this.historyForm, this.patientsFormArray)
